 ...
 */
final class Version20220113095715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mentor ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mentor ADD CONSTRAINT FK_801562DEA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_801562DEA76ED395 ON mentor (user_id)');
        ...
        $this->addSql('ALTER TABLE user DROP student_id, DROP mentor_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_801562DEA76ED395 ON mentor');
        $this->addSql('ALTER TABLE mentor DROP user_id');
        $this->addSql('ALTER TABLE student DROP FOREIGN KEY FK_B723AF33A76ED395');
        $this->addSql('DROP INDEX UNIQ_B723AF33A76ED395 ON student');
        $this->addSql('ALTER TABLE student DROP user_id');
        $this->addSql('ALTER TABLE user ADD student_id INT DEFAULT NULL, ADD mentor_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649DB403044 FOREIGN KEY (mentor_id) REFERENCES mentor (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
